 ...
 * Use the [RequestItemFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RequestItemFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RequestItemFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RequestItemFragment().apply {
